...
const faqItems = [
  ...
  {
    question: "Q. 왜 공간디자인에서 웹디자인으로 직무를 변경하셨나요?",
    answer: "공간디자인을 하며 사람의 동선과 시선의 흐름을 설계하는 과정에 큰 매력을 느꼈습니다. 하지만 물리적인 공간보다 더 빠르게 변화하고, 더 많은 사람의 경험에 직접적으로 영향을 줄 수 있는 영역이 디지털 환경이라고 생각하게 되었습니다. 공간에서 고민하던 구조와 흐름에 대한 사고를 웹 환경에 확장해보고 싶었고, 사용자의 행동을 자연스럽게 이끄는 화면을 설계하는 디자이너로 성장하고자 직무를 전환하게 되었습니다.",
  },
  {
